...
import LineSegmentIntersectionPage from './pages/line-segment-intersection/LineSegementIntersectionPage'
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="algorithms/segment-intersection" element={<LineSegmentIntersectionPage />} />
        </Route>
      </Routes>
    </BrowserRouter>
  )
